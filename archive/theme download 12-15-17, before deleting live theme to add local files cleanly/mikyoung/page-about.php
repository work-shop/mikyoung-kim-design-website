			...
			<div class="row">
				...
				<div class="col-sm-3 page-nav fixed-nav" id="about-nav">
					<ul>
						...
						<li><a href="#about_team"class="jump-about hidden">team</a></li>
				...
				<div class="col-sm-9 col-sm-offset-3" id="about-content">
					<div class="page-content about">
						...
						<section class="about-section hidden" id="about_team">
							<h3 class="section-heading bg-brand">Team</h3>						
							...
							<div class="section-body row" id="team">
								<?php if( have_rows('team','option') ): ?>
									...
									<?php while( have_rows('team','option') ): the_row(); ?>
										...
										<?php if( $active ): ?>
											<div class="team-member person modal-toggle" id="person-<?php echo $team_count; ?>" data-modal-target="modal-person-<?php echo $team_count; ?>">
												...
												<h4 class="person-name "><span class="bold"><?php echo $name; ?></span>
													<br class="visible-xs">
													<?php echo $title; ?></h4>
													<a class="small bio-link modal-toggle hidden" href="#" data-modal-target="modal-person-<?php echo $team_count; ?>">Click for Bio</a>
												</div>
